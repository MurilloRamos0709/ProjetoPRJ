...
public class PessoaFisica extends Cliente {
	...
	@Override
	public void cadastrar() {// sobreescrever a class paiiiiiiii
		// tentativa de criar um arquivo no erro
		FileWriter arquivo = null;

		try {
			arquivo = new FileWriter("c\\Guilherme\\cadastro.txt");
			arquivo.append(this.nome);
			arquivo.append(this.getEmail());
			arquivo.append(this.getTelefone());
			arquivo.append(this.getEndereco());
			arquivo.append(this.getCpf());
			arquivo.append(this.getRg());
			arquivo.append("--------------------");
